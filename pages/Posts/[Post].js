...
const JobPosting = () => {
  ...
  const aplicar = async () => {
    ...
    const response = await fetch(
      `/api/Users/ofertas?aplicar=true&id=${router.query.id}`,
      {
        method: "PUT",
        headers: {
  ...
  async function eliminar() {
    ...
    if (result.isConfirmed) {
      ...
      if (!response.ok) {
        ...
        Swal.fire("Eliminado!", "Tu oferta ha sido eliminada.", "success").then(
          () => {
                ...
                <div className="flex items-center">
                  ...
                  <div className="flex-col flex-wrap flex-grow">
                    {!isEditable ? (
                      ...
                      <input
                        type="text"
                        className="text-2xl font-bold ml-2 block bg-gray-50 rounded-lg border border-blue-200 focus:outline-none"
                    ...
                    {!isEditable ? (
                      ...
                      <>
                        ...
                        <textarea
                          ...
                          defaultValue={editedPost.requirements}
                          onChange={(e) =>
                            setEditedPost({
                              ...editedPost,
                        ...
                        <textarea
                          className="mb-4 w-full bg-gray-50 rounded-lg border border-blue-200 focus:outline-none"
                          defaultValue={editedPost.benefits}
                          onChange={(e) =>
                            setEditedPost({
                              ...editedPost,
                        ...
                        <input
                          className="mb-4 w-full bg-gray-50 rounded-lg border border-blue-200 focus:outline-none"
                          defaultValue={editedPost.contract_type}
                          onChange={(e) =>
                            setEditedPost({
                              ...editedPost,
                        ...
                        <input
                          className="mb-4 w-full bg-gray-50 rounded-lg border border-blue-200 focus:outline-none"
                          defaultValue={editedPost.salary}
                          onChange={(e) =>
                            setEditedPost({
                              ...editedPost,
                        ...
                        <input
                          type="date"
                          className="mb-4 w-full bg-gray-50 rounded-lg border border-blue-200 focus:outline-none"
                          defaultValue={editedPost.start_date}
                          onChange={(e) =>
                            setEditedPost({
                              ...editedPost,
                        ...
                        <input
                          type="date"
                          className="mb-4 w-full bg-gray-50 rounded-lg border border-blue-200 focus:outline-none"
                          defaultValue={editedPost.application_deadline}
                          onChange={(e) =>
                            setEditedPost({
                              ...editedPost,
                ...
                <div className="flex flex-col sm:flex-row items-center">
                  <div className="w-full sm:w-1/2 flex-col flex-wrap mt-4 mb-4">
                    ...
                    {!isEditable ? (
                      <>
                        <p className="ml-2">
                          {post.contact_information.contact_name}
                        </p>
                        <p className="ml-2">
                          {post.contact_information.contact_email}
                        </p>
                        <p className="ml-2 mb-4">
                          {post.contact_information.contact_phone}
                        </p>
                      </>
                    ) : (
                      <>
                        <input
                          className="ml-2 w-full bg-gray-50 rounded-lg border border-blue-200 focus:outline-none"
                          defaultValue={
                            editedPost.contact_information.contact_name
                          }
                          onChange={(e) =>
                            setEditedPost({
                              ...editedPost,
                              contact_information: {
                                ...editedPost.contact_information,
                        ...
                        <input
                          className="ml-2 w-full bg-gray-50 rounded-lg border border-blue-200 focus:outline-none"
                          defaultValue={
                            editedPost.contact_information.contact_email
                          }
                          onChange={(e) =>
                            setEditedPost({
                              ...editedPost,
                        ...
                        <input
                          className="ml-2 w-full bg-gray-50 rounded-lg border border-blue-200 focus:outline-none"
                          defaultValue={
                            editedPost.contact_information.contact_phone
                          }
                          onChange={(e) =>
                            setEditedPost({
                              ...editedPost,
                  ...
                  <div className="w-full sm:w-1/2 pl-0 sm:pl-8 flex-col flex-wrap mt-4 mb-4">
                    ...
                    {!isEditable ? (
                      ...
                      <>
                        <textarea
                          className="mb-4 w-full bg-gray-50 rounded-lg border border-blue-200 focus:outline-none"
                          defaultValue={editedPost.application_method}
                          onChange={(e) =>
                            setEditedPost({
                              ...editedPost,
                        ...
                        <input
                          type="checkbox"
                          checked={editedPost.aplicable}
                          onChange={(e) =>
                            setEditedPost({
                              ...editedPost,
                              aplicable: e.target.checked,
                            })
                          }
                        />
                      </>
                ...
                {session.user.id === post.company_id ? (
                  <>
                    {isEditable ? (
                      <>
                        <button
                          className="px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 active:bg-red-800 focus:outline-none"
                          onClick={() => {
                            setIsEditable(!isEditable);
                            setEditedPost({ ...post });
                          }}
                        ...
                        <button
                          className="px-4 py-2 ml-1 bg-green-400 text-white rounded-md hover:bg-green-500 active:bg-green-600 focus:outline-none"
                          onClick={() => guardar()}
                        >
                          Guardar
                        </button>
                      ...
                      <>
                        ...
                        <button
                          className="px-4 py-2 ml-1 bg-slate-500 text-white rounded-md hover:bg-slate-600 active:bg-slate-700 focus:outline-none"
                          onClick={() => {
                            setIsEditable(!isEditable);
                            setEditedPost({ ...post });
                          }}
                  ...
                  <>
                    ...
                    post.aplicable ? (
                      <>
                        ...
                        >
                          {post?.aplicantes?.includes(session.user.id)
                            ? "Ya has aplicado"
                            : "Aplicar"}
                        </button>
                      </>
                ...
                <div className="bg-white rounded-lg shadow-md mb-6 p-6">
                  {post.aplicantes ? (
                    ...
                    <p className="text-center text-gray-500 text-xl">
                      Todavía no se han registrado aplicantes
                    </p>
                  )}
                </div>
              </>
