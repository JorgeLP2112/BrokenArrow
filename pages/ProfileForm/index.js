...
const Step0 = ({ userId, nextStep }) => {
  ...
  return (
    <div className="mx-auto w-full sm:w-3/4 md:w-2/5 bg-white shadow-md p-4 rounded-md">
      ...
      <label className="block">Crea un usuario y contraseña nuevos</label>
      <input
        type="text"
        value={username}
...
const Step1 = ({ userId, nextStep, prevStep }) => {
          ...
          >
            <div className="block flex flex-col items-center">
              ...
              <div className="w-full text-sm">
                Perfil estándar para aplicar a las vacantes de las empresas.
              </div>
            </div>
          </label>
        </li>
        <li>
          ...
          >
            <div className="block flex flex-col items-center">
              ...
              <div className="w-full text-sm">
                Perfil especializado que ofrece las herramientas que las
                empresas necesitan para ofertar vacantes
              </div>
            </div>
          </label>
        </li>
  ...
  return (
    <div className="mx-auto w-full sm:w-3/4 md:w-2/5 bg-white shadow-md p-4 rounded-md">
      ...
      <h3 className="text-base font-bold mb-4">
        Cuéntanos sobre tu educación superior
      </h3>
        ...
        <div key={index} className="flex flex-wrap bg-gray-50">
          <div className="w-1/2 p-2">
            ...
            <input
              type="text"
              name={`language-${index}`}
              onChange={handleChange(index, "language")}
              value={lang.language}
              className="w-full p-2 border rounded-md"
            />
          </div>
          <div className="w-1/2 p-2">
            ...
            <select
              ...
              onChange={handleChange(index, "proficiency")}
...
const Step9 = ({ nextStep, prevStep, values, setValues }) => {
  ...
  return (
    <div className="mx-auto w-full sm:w-3/4 md:w-2/5 bg-white shadow-md p-4 rounded-md">
      <h2 className="text-xl font-bold mb-4">Completa tu perfil</h2>
      <h2 className="text-lg font-bold mb-4">
        ¿Cuentas con alguna certificacion?
      </h2>
        ...
        <div key={index} className="flex flex-wrap bg-gray-50">
          ...
          <div className="w-1/3 p-2">
            ...
            <input
              ...
              onChange={handleChange(index, "issuing_organization")}
...
const Step10 = ({ nextStep, prevStep, values, setValues }) => {
  ...
  return (
    <div className="mx-auto w-full sm:w-3/4 md:w-2/5 bg-white shadow-md p-4 rounded-md">
      <h2 className="text-xl font-bold mb-4">Completa tu perfil</h2>
      <h2 className="text-lg font-bold mb-4">
        ¿Con cuáles habilidades sociales (Soft Skills)?
      </h2>
...
const Step11 = ({ nextStep, prevStep, values, setValues }) => {
  ...
  return (
    <div className="mx-auto w-full sm:w-3/4 md:w-2/5 bg-white shadow-md p-4 rounded-md">
      <h2 className="text-xl font-bold mb-4">Completa tu perfil</h2>
      <h2 className="text-lg font-bold mb-4">
        ¿A qué correo te gustaria que las empresas te contacten?
      </h2>
      <input
        type="text"
        name="email"
...
const MultiStepForm = () => {
  ...
  switch (step) {
    ...
    case 13:
      return <Step13 prevStep={prevStep} values={values} />;
  }
};
